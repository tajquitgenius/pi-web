...
export default {
  ...
  'index.mobileThreads': 'Threads',
  'index.mobileProjects': 'Projects',
  'index.mobileNavigation': 'Navigation',
  'index.openNavigation': 'Open navigation',
  ...
  'index.taskSettings': 'Task settings',
  'index.providerAndModel': 'Provider and model',
  'index.thinking': 'Thinking',
  'index.thinkingLevel': 'Thinking level',
  'index.noAuthenticatedModels': 'No authenticated models',
  'index.chooseProviderModel': 'Choose a provider and model.',
  ...
  'index.creatingTask': 'Creating task…',
  'index.createTask': 'Create task',
  'index.filterSessions': 'Filter sessions',
  'index.searchSessionsLabel': 'Search sessions',
  'index.filterByProject': 'Filter by project',
  'index.allProjects': 'All projects',
  'index.projectsRegion': 'Projects',
  'index.sessionsRegion': 'Sessions',
  'index.noProjectsYet': 'No projects yet',
  'index.createTaskForProject': 'Create a task to start a Pi project.',
  'index.projectRunning': '{count} running',
  'index.projectThreadOne': '1 thread',
  'index.projectThreads': '{count} threads',
  'index.noMatchingSessions': 'No matching sessions',
  'index.tryAnotherSearchProject': 'Try another search or project.',
  'index.sessionsLoadFailed': 'Could not load sessions.',
  'index.now': 'Now',
  ...
  'conversation.attachImages': 'Attach images',
  'conversation.chooseImageAttachments': 'Choose image attachments',
  'conversation.projectInspector': 'Project inspector',
  'conversation.threadActions': 'Thread actions',
  'conversation.openRuntime': 'Choose model and thinking level',
  'conversation.runtime': 'Session runtime',
  'conversation.modelAndThinking': 'Model and thinking',
  'conversation.providerModel': 'Account / provider and model',
  'conversation.thinkingLevel': 'Thinking level',
  'conversation.updateSession': 'Update session',
  'conversation.updating': 'Updating…',
  'conversation.loadModelsFailed': 'Could not load models.',
  'conversation.updateRuntimeFailed': 'Could not update session settings.',
  'conversation.runtimeReady': 'Pi is ready',
  'conversation.runtimeWorking': 'Pi is working',
  'conversation.runtimeUnavailable': 'Pi runtime unavailable: {error}',
  'conversation.runtimeUnavailableWithoutError': 'Pi runtime unavailable',
  'conversation.provider': 'Provider',
  'conversation.model': 'Model',
  'conversation.fileSuggestionsLoadFailed': 'Could not load file suggestions.',
  'conversation.commandSuggestionsLoadFailed': 'Could not load Pi commands.',
  ...
  'conversation.toolDetails': '{action} {name} tool details',
  'conversation.thinking': 'Thinking',
  'conversation.hideReasoning': 'Hide reasoning',
  'conversation.showReasoning': 'Show reasoning',
  'conversation.userAttachment': 'User attachment',
  'conversation.assistant': 'Assistant',
  'conversation.copyResponse': 'Copy response',
  'conversation.responseCopied': 'Response copied',
  'conversation.copyFailed': 'Copy failed — try again',
  'conversation.responseCancelled': 'Response cancelled.',
  'conversation.responseFailed': 'The response failed.',
  'conversation.modelChanged': 'Model changed to {model}',
  'conversation.thinkingChanged': 'Thinking changed to {level}',
  'conversation.compacted': 'Earlier context compacted',
  'conversation.branchSummary': 'Branch summary',
  'conversation.update': 'Update',
  'conversation.loadOlderFailed': 'Could not load older messages.',
  'conversation.sendFailed': 'Could not send message.',
  'conversation.cancelFailed': 'Could not cancel the response.',
  'conversation.fileSuggestions': 'Project file suggestions',
  'conversation.commandSuggestions': 'Pi command suggestions',
  'conversation.loading': 'Loading…',
  'conversation.noFiles': 'No matching files',
  'conversation.noCommands': 'No matching Pi commands',
  ...
  'conversation.emptyTitle': 'What should pi work on?',
  'conversation.emptyHint': 'Send a task below to begin in {project}.',
  'conversation.sending': 'Sending',
  'conversation.assistantWorking': 'Assistant · working',
