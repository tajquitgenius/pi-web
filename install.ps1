...
# ~/.config/pi-web/env (including PI_WEB_REMOTE_AUTH) and starts the binary hidden.
...
# from the env file (including PI_WEB_REMOTE_AUTH). Regenerated on every install.
`$envFile = '$EnvFile'
